...
<Card title="Getting Started" icon="🚀">
  ...
  **Warning:** Never click **"Discard Commits"** when syncing your fork! This will permanently delete your own raid results and data. Always use the default sync option to keep your changes.
