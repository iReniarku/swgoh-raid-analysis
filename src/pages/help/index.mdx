...
<Card title="Getting Started" icon="🚀">
  Welcome to the Order 66 Raid Analysis tool! This application automatically analyzes your guild's raid performance based on CSV files from Wookiebot.

  ## Quick Setup

  ### 1. Fork the Repository
  1. Go to [https://github.com/DennisBecker/order66](https://github.com/DennisBecker/order66)
